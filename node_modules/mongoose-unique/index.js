...
exports.initialize = function (connection) {
      try {
            ...
            if (ex.name === 'MissingSchemaError') {
                  ...
                  counterSchema.index({field: 1, counter: 1}, {unique: true, required: true, index: -1});
      ...
      try {
            Unique = connection.model('uniques');
      } catch (ex) {
            if (ex.name === 'MissingSchemaError') {
                  // Create new counter schema.
                  uniqueSchema = new mongoose.Schema({
                        _id: {type: Number, require: true},
                        model: {type: String, require: true}
                  });

                  // Create a unique index using the "field" and "model" fields.
                  //uniqueSchema.index({field: 1, model: 1}, {unique: true, required: true, index: -1});

                  // Create model using new schema.
                  Unique = connection.model('uniques', uniqueSchema);
            }
            else
                  throw ex;
      }
...
exports.plugin = function (schema, options) {
      ...
      var settings = {
                  counter: null, // The model to configure the plugin for.
      ...
      IdentityCounter.findOne(
            {counter: settings.counter, field: settings.field},
      ...
      schema.post('save', function (a, b, c) {
